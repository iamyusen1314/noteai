...
- After the low-memory Blueprint variables were manually synced, the cloud Cron completed collection without OOM and produced 114 real homefeed keywords. It correctly hard-failed because beauty, home, and fitness lacked sufficient fresh evidence; search discovery had been interrupted by JavaScript execution-context destruction during navigation, so scrolling now uses Playwright mouse input instead of page evaluation.
