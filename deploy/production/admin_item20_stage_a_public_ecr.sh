...
task_root='/var/lib/noteai/admin-5335-current-public-ecr'
...
inspect_container='noteai-admin-item20-inspect-public-ecr'
phase='preflight'
...
offline_self_test() (
  ...
  fixture_root="$(mktemp -d "${TMPDIR:-/tmp}/noteai-admin-stage-a-public-ecr.XXXXXX")"
  case "$fixture_root" in
    "${TMPDIR:-/tmp}"/noteai-admin-stage-a-public-ecr.*) ;;
    *) exit 95 ;;
  esac
...
case "$task_root" in
  /var/lib/noteai/admin-5335-current-public-ecr) ;;
