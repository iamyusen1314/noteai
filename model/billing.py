...
TIERS: dict[str, dict] = {
    ...
    "pro": {
        ...
        "quotas": {},
        "features": ["260 个30天周期积分", "付费创建归档在账户存在期间无产品到期日", "AI记忆学习", "适合个人创作者"],
    },
    "growth": {
        "name":  "成长版",
        "price": 199,
        ...
        "quotas": {},
        "features": ["560 个30天周期积分", "付费创建归档在账户存在期间无产品到期日", "适合稳定更新账号"],
    },
    "pro_plus": {
        "name":  "专业版",
        "price": 299,
        ...
        "quotas": {},
        "features": ["900 个30天周期积分", "最多3/4调度槽位给优先队列（非完成时效承诺）", "付费创建归档在账户存在期间无产品到期日"],
    },
    "studio": {
        "name":  "工作室版",
        "price": 399,
        ...
        "quotas": {},
        "features": ["1250 个30天周期积分", "单主账号多小红书账号运营", "最多3/4调度槽位给优先队列（非完成时效承诺）"],
    },
}
