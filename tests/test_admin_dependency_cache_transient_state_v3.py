...
import verify_admin_dependency_cache_transient_state_v3 as verifier  # noqa: E402


class AdminDependencyCacheTransientStateV3Tests(unittest.TestCase):
    BUILDER_NAME = "noteai-admin-cache-v3-producer-123"

    def _fixture(self, root: Path) -> tuple[Path, Path]:
        docker_config = root / "noteai-empty-docker-config-v3"
        buildx_config = root / "noteai-buildx-state-v3"
