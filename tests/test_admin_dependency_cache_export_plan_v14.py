...
import verify_admin_dependency_cache_export_plan_v14 as verifier  # noqa: E402
        ...
        if path == "/actions/runs":
            items = [
                ...
                },
                {
                    ...
                    "path": verifier.V14_WORKFLOW_PATH,
                },
...
class AdminDependencyCacheExportPlanV14Tests(unittest.TestCase):
    @staticmethod
    def _template() -> dict:
    ...
    def test_reviewed_authorities_validate_without_git_state(self):
        ...
        self.assertEqual(verifier._validate_v13_superseded_predecessor(), [])
        ...
        for name, candidate in (
            ...
            (
                ...
                workflow.replace(
                    ...
                    "NOTEAI_V14_LEDGER_CONTRACT_PATH_REMOVED: true",
                ),
            ),
            (
    ...
    def test_live_ledger_pre_and_post_cleanup_snapshots(self):
        ...
        self.assertEqual(len(pre["legacy"]), 12)
    ...
    def test_live_ledger_contract_copy_requires_private_mode(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with (
                mock.patch.dict(
                    os.environ,
                    {"NOTEAI_V14_LEDGER_CONTRACT_PATH": str(contract)},
                ),
    ...
    def test_exact_checkpoint_receipt_and_activation_git_history(self):
        with (
            ...
            git("init", "--quiet")
            git("config", "user.name", "NoteAI V14 Test")
            git("config", "user.email", "noteai-v14@example.invalid")
    ...
    def test_python_optimized_mode_has_no_assert_contract(self):
        ...
        self.assertNotIn("__V14_", source)
